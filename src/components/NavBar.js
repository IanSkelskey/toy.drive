    ...
    return (
        <nav className="sticky border-2 border-red-900 border-opacity-20 top-0 z-30 w-full h-14 mb-2 rounded-full bg-candy-cane-pattern">
            ...
            <ul className="flex justify-around h-full items-center font-bold text-white underline sm:text-lg text-sm">
                <li className="h-full flex items-center px-4 z-50 hover:text-brand-yellow hover:underline">
                    <Link to="/toy.drive/">Home</Link>
                </li>
                <li className="h-full flex items-center px-4 z-50 hover:text-brand-yellow hover:underline">
                    <Link to="/toy.drive/wishlist">Wishlist</Link>
                </li>
                <li className="h-full flex items-center px-4 z-50 hover:text-brand-yellow hover:underline">
                    <Link to="/toy.drive/drop-off">Drop-off Locations</Link>
                </li>
                <li className="h-full flex items-center px-4 z-50 hover:text-brand-yellow hover:underline">
                    <Link to="/toy.drive/about">About Us</Link>
                </li>
            </ul>
        </nav>
    );
