const bristolPlazaStarbucksMapURL = 'https://maps.app.goo.gl/Z1WjSZ93vp5RSik4A';
const bristolPlazaStarbucksMapEmbedURL =
...
const bristolRt6CampMapURL = 'https://maps.app.goo.gl/4oH99njkedwJEGKYA';
const bristolRt6CampMapEmbedURL =
...
const tunxisMapURL = 'https://maps.app.goo.gl/dAbe3ad7DdrfV3rB8';
const tunxisMapEmbedURL =
...
const discordServerURL = 'https://discord.gg/bv2gJbGngh';
const facebookGroupURL =
    'https://www.facebook.com/groups/sbuxtoydrive/?mibextid=oMANbw';
const fundraisingURL = 'https://give.connecticutchildrens.org/team/539713';
const donateURL =
    'https://give.connecticutchildrens.org/give/t539713/#!/donation/checkout';
